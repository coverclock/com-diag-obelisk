...
#include "com/diag/obelisk/obelisk_release.h"

const char COM_DIAG_OBELISK_RELEASE_KEYWORD[] = "COM_DIAG_OBELISK_RELEASE=" COM_DIAG_OBELISK_RELEASE;
const char * COM_DIAG_OBELISK_RELEASE_VALUE = &COM_DIAG_OBELISK_RELEASE_KEYWORD[sizeof("COM_DIAG_OBELISK_RELEASE=") - 1];
